...
const toastVariants = cva(
  [
    "group pointer-events-auto relative flex w-full items-start justify-between gap-4 overflow-hidden",
    ...
    "sm:data-[state=open]:slide-in-from-bottom-5",
  ].join(" "),
  {
    variants: {
      variant: {
        default:
          "bg-[#121826]/90 text-white border-white/10",
  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      [
        ...
        "group-[.destructive]:border-red-400/30",
  ...
  <ToastPrimitives.Close
    ...
    className={cn(
      [
        ...
        "group-[.destructive]:text-red-200/70",
        "group-[.destructive]:hover:bg-red-500/20",
